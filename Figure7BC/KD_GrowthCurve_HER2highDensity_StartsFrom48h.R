# This is a modification of code from "KD_GrowthCurve_HER2highDensity.R" by using data "KD_GrowthCurve_EMH_Plotting_2020.04.14.xlsx" - Excel sheet: "D492HER2"
# instead of "KD_GrowthCurve_EMH_Plotting.xlsx" - Excel sheet: "HER2highDensity"
...
library(readxl)
datNo <- read_xlsx("KD_GrowthCurve_EMH_Plotting_2020.04.14.xlsx", sheet = "D492HER2")
...
dat$Time.Point <- factor(rep(paste0("T", seq(48, 90, 6), "h"), times = rep(6, 8)), 
                         levels = paste0("T", seq(48, 90, 6), "h"))

dat$Treatment <- factor(rep(c("siGALE", "siGFPT2", "siPGM2L1", "Scr", "siUGDH", "WT"), 8), 
