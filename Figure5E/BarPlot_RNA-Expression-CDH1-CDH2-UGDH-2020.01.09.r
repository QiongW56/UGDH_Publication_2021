# Upload data for RNA expression
# raw data are under "C:\Users\lenovo\OneDrive - Háskóli Íslands\PC-HI\4 Experiments documents_QIONG\20 UGDH-Paper\1-WideType-D492-HMLE-PMC42"
setwd("C:/Users/lenovo/OneDrive - Háskóli Íslands/PC-HI/5-2 ProteomicPaper-UGDH")
library(readxl)
path <- "C:/Users/lenovo/OneDrive - Háskóli Íslands/PC-HI/5-2 ProteomicPaper-UGDH/RNA-Expression-CDH1-CDH2-UGDH.xlsx"
excel_sheets(path = path)
# [1] "D492-CDH1"  "HMLE-CDH1"  "PMC42-CDH1" "D492-CDH2"  "HMLE-CDH2"  "PMC42-CDH2"
# [7] "D492-UGDH"  "HMLE-UGDH"  "PMC42-UGDH"

funPlot <- function(n){
  funData <- function(x, CellLine){
    library(readxl)
    dat <- read_excel("RNA-Expression-CDH1-CDH2-UGDH.xlsx", sheet = x)
    dat <- data.frame(dat)
